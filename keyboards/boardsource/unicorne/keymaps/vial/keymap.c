...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //`--------------------+--------------------+--------------------+--------------------+--------------------+--------------------+--------------------.   ,--------------------+--------------------+--------------------+--------------------+--------------------+--------------------+--------------------'
                                                                                            LCTL_T(KC_DELETE),     LALT_T(KC_BSPC),     LT(2, KC_ENTER),         LT(3, KC_SPACE),  RGUI_T(KC_PSCR),       ALL_T(KC_F24)
  //                                                                                    `--------------------+--------------------+--------------------'   `--------------------+--------------------+--------------------'
  ...
  //|--------------------+--------------------+--------------------+--------------------+--------------------+--------------------|                                             |--------------------+--------------------+--------------------+--------------------+--------------------+--------------------|
                  KC_CAPS,          LCTL(KC_Z),          LCTL(KC_X),          LCTL(KC_C),          LCTL(KC_V),          LCTL(KC_B),                                                    LSFT(KC_EQUAL),          LSFT(KC_1),          LSFT(KC_2),          LSFT(KC_3),       LSFT(KC_BSLS),      LSFT(KC_SLASH),
  //`--------------------+--------------------+--------------------+--------------------+--------------------+--------------------+--------------------.   ,--------------------+--------------------+--------------------+--------------------+--------------------+--------------------+--------------------'
  ...
  //,--------------------+--------------------+--------------------+--------------------+--------------------+--------------------.                                             ,--------------------+--------------------+--------------------+--------------------+--------------------+--------------------.
                 KC_GRAVE,           RCS(KC_P),        LSA(KC_DOWN),         LALT(KC_UP),          LSA(KC_UP),          LCTL(KC_D),                                                        KC_KP_PLUS,                KC_7,                KC_8,                KC_9,         KC_KP_MINUS,             KC_BSPC,
  //|--------------------+--------------------+--------------------+--------------------+--------------------+--------------------|                                             |--------------------+--------------------+--------------------+--------------------+--------------------+--------------------|
                    MO(5),          LCTL(KC_A),             KC_LEFT,       LALT(KC_DOWN),            KC_RIGHT,           RCS(KC_L),                                                           KC_LBRC,                KC_4,                KC_5,                KC_6,             KC_RBRC,           KC_DELETE,
  //|--------------------+--------------------+--------------------+--------------------+--------------------+--------------------|                                             |--------------------+--------------------+--------------------+--------------------+--------------------+--------------------|
                   0x7c73,          LCTL(KC_Z),          LCTL(KC_X),          LCTL(KC_C),          LCTL(KC_V),          LCTL(KC_Y),                                                          KC_EQUAL,                KC_1,                KC_2,                KC_3,             KC_BSLS,         KC_KP_COMMA,
  //`--------------------+--------------------+--------------------+--------------------+--------------------+--------------------+--------------------.   ,--------------------+--------------------+--------------------+--------------------+--------------------+--------------------+--------------------'
