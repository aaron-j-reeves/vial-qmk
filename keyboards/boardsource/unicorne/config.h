...
//#define ANALOG_JOYSTICK_AXIS_MIN              // Sets the lower range to be considered movement. - default 0
//#define ANALOG_JOYSTICK_AXIS_MAX              // Sets the upper range to be considered movement. - default 1023
#define ANALOG_JOYSTICK_AUTO_AXIS               // Sets ranges to be considered movement automatically.

#define ANALOG_JOYSTICK_SPEED_MAX 4          // The maximum value used for motion. - default 2
#define ANALOG_JOYSTICK_SPEED_REGULATOR 25      // The divisor used to slow down movement. (lower makes it faster) - default 20
